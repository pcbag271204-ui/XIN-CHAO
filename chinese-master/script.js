...
const fullVocabulary = [
  ...
  // Bài 5
    ...
    //Bài 6
         ...
         { lesson: 6, hanzi: "水果", pinyin: "shuǐguǒ", meaning: "hoa quả, trái cây" },
         ...
         { lesson: 6, hanzi: "再买", pinyin: "zài mǎi", meaning: "mua thêm / mua lại" },
         { lesson: 6, hanzi: "斤", pinyin: "jīn", meaning: "cân (1 斤 = 0,5 kg)" },
         { lesson: 6, hanzi: "公斤", pinyin: "gōngjīn", meaning: "kilôgam (kg)" },
         { lesson: 6, hanzi: "个", pinyin: "gè", meaning: "cái, chiếc, người — lượng từ phổ biến" },
         ...
         { lesson: 6, hanzi: "条", pinyin: "tiáo", meaning: "chiếc/con (cá, quần, đường...)" },
         { lesson: 6, hanzi: "张", pinyin: "zhāng", meaning: "tờ, cái (giấy, vé, bàn...)" },
         { lesson: 6, hanzi: "辆", pinyin: "liàng", meaning: "chiếc (lượng từ dùng cho xe)" },
         { lesson: 6, hanzi: "把", pinyin: "bǎ", meaning: "cái/chiếc (vật có cán, tay cầm)" },
